...
- **Pílula de seleção de largura fixa e esqueleto só na primeira carga** — ajustes pedidos depois da primeira publicação no Tasks: a pílula de seleção mantém a largura entre opções (rótulo curto na pílula, nome completo no menu) e o painel reaberto, ou com o recorte trocado, mostra na hora o que já tem em memória, atualizando em silêncio, em vez de piscar esqueleto.
